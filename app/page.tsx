...
export default function Home() {
  ...
  return <main>
    ...
    <section className="final-cta" id="contact"><div className="cta-mark"><Mark size={86}/></div><div className="section-kicker centered">08 / START A CONVERSATION</div><h2>Let&apos;s build something<br/><em className="accent">exceptional.</em></h2><p>Tell us what needs to exist. We&apos;ll help work out how it should be engineered.</p><a className="btn primary" href="#contact">Start a conversation</a><small>Connect final business contact details before production launch.</small></section>
