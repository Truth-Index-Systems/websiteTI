...
export default function Home() {
  ...
  return <main>
    ...
    <section className="section bespoke" id="solutions"><div className="section-kicker">05 / ENGINEERING SOLUTIONS</div><div className="split"><div><h2>Every business has<br/>unique challenges.</h2><h3 className="solutions-line">We engineer the solution.</h3></div><div className="lead-column"><p>Every organisation is different. We design and engineer software around your operations, objectives and future growth rather than forcing your business to adapt to generic tools.</p></div></div><div className="portfolio single"><article className="case handover"><div className="case-top"><div className="handover-icon">H</div><div><div className="micro teal">ENGINEERING SOLUTION / PLATFORM</div><h3>HandoverAI</h3></div></div><p>Workplace knowledge-transfer software engineered to preserve operational expertise, improve business continuity and reduce knowledge loss.</p><a href="https://www.handoverai.co.uk" target="_blank" rel="noreferrer">Visit handoverai.co.uk ↗</a></article></div><div className="service-grid">{services.map(([title,desc])=><article key={title}><h3>{title}</h3><p>{desc}</p></article>)}</div></section>
