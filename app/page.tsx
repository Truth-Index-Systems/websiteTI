...
export default function Home() {
  ...
  return <main>
    ...
    <section className="section technology" id="technology"><div className="section-kicker">02 / PROPRIETARY TECHNOLOGY</div><div className="genesis-wrap"><div className="genesis-badge"><div className="genesis-core"><GenesisMark size={132}/></div><div className="genesis-orbit orbit-a"/><div className="genesis-orbit orbit-b"/></div><div><div className="micro">TRUTH INDEX SYSTEMS / GENESIS</div><div className="product-lockup genesis-lockup"><GenesisMark size={54}/><span>GENESIS <b>T8</b></span></div><h2>Genesis T8<span>™</span></h2><h3>The Intelligence Engine.</h3><p>Genesis T8 is the proprietary intelligence platform developed by Truth Index Systems. It provides a structured foundation for reasoning, evidence assessment and intelligent software systems.</p></div></div><div className="signal-chain">{["Knowledge","Reasoning","Evidence","Intelligence","Software"].map((x,i)=><div className="signal" key={x}><span>{String(i+1).padStart(2,"0")}</span><strong>{x}</strong></div>)}</div></section>

    <section className="section cie"><div className="section-kicker">03 / COMMERCIAL INTELLIGENCE ENGINE</div><div className="split cie-head"><div><div className="product-lockup cie-lockup"><CieMark size={52}/><span>CIE <b>v1.0</b></span></div><h2>CIE <span>v1.0</span></h2><h3>Commercial intelligence,<br/>engineered.</h3></div><p className="lead-column">The Commercial Intelligence Engine is the first production intelligence engine built on Genesis T8, transforming structured reasoning into practical commercial intelligence.</p></div><div className="capability-grid">{capabilities.map(([title,desc],i)=><article className="capability" key={title}><div className="capability-top"><span>{String(i+1).padStart(2,"0")}</span><i/></div><h3>{title}</h3><p>{desc}</p></article>)}</div></section>

    <section className="section product" id="products"><div className="section-kicker">04 / FLAGSHIP PRODUCT</div><div className="market-card"><div className="market-content"><div className="market-logo"><MarketRouteMark size={54}/><strong>Market<span>Route</span></strong></div><div className="micro blue">POWERED BY GENESIS T8™</div><h2>Find the route.<br/>Not just the lead.</h2><p>MarketRoute is a commercial intelligence platform that researches markets, discovers companies and identifies evidence-backed routes to opportunity.</p><a className="btn blue-btn" href="https://www.marketroute.co.uk" target="_blank" rel="noreferrer">Visit marketroute.co.uk</a></div><div className="route-visual" aria-hidden="true"><div className="route-grid"/><div className="node n1"/><div className="node n2"/><div className="node n3"/><div className="node n4"/><div className="node n5"/><svg viewBox="0 0 500 420"><path d="M68 320 C165 260, 190 120, 305 150 S410 285,455 90"/><path className="soft" d="M45 155 C160 210, 235 360, 450 300"/></svg></div></div></section>

    <section className="section bespoke" id="solutions"><div className="section-kicker">05 / ENGINEERING SOLUTIONS</div><div className="split"><div><h2>Every business has<br/>unique challenges.</h2><h3 className="solutions-line">We engineer the solution.</h3></div><div className="lead-column"><p>Every organisation is different. We design and engineer software around your operations, objectives and future growth rather than forcing your business to adapt to generic tools.</p></div></div><div className="solutions-intro-rule"><span>ENGINEERING CAPABILITIES</span><span>BUILT AROUND THE PROBLEM</span></div><div className="service-grid">{services.map(([title,desc])=><article key={title}><h3>{title}</h3><p>{desc}</p></article>)}</div></section>
